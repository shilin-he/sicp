...
;; set a value to B
;; set a value to A, which is not equal the square root of 
;; the value of B, a new value for A will be calculated,
;; which is not equal to the origianl value of A. 
